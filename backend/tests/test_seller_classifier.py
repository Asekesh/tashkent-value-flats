...
def _mk(source_id: str, seller_id: str) -> Listing:
    return Listing(
        source="uybor", source_id=source_id, url="u", title="t", price=500, currency="USD",
        ...
        deal_type="rent", price_period="month", seller_id=seller_id, seen_at=datetime.utcnow(),
        market_sample_size=0, is_below_market=False, duplicate_count=1,
    )
