...
class Settings(BaseSettings):
    ...
    # Пороги «вменяемости» для аренды (помесячной). У аренды цена/м² в ~100x
    # меньше продажи, поэтому свои нижние границы: иначе sale-пороги отрезают
    # всю аренду. ~$50/мес и ~$0.3/м²/мес отсекают мусор/опечатки, реальную
    # аренду Ташкента ($300–2000/мес, $5–30/м²) пропускают.
